...
public final class TaskPregenZPlaceholder extends ChunkyPlaceholder {
    public TaskPregenZPlaceholder(final Chunky chunky) {
        super(chunky);
    }
    ...
    public Tag apply(final ArgumentQueue argumentQueue, final Context context) {
        ...
        if (runningTask == null) {
            ...
            return Tag.preProcessParsed(Long.toString(runningTask.getProgress().getChunkZ()));
        }
    }
}
