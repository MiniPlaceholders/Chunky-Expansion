...
public final class TaskPregenMinutesPlaceholder extends ChunkyPlaceholder {
    public TaskPregenMinutesPlaceholder(final Chunky chunky) {
        super(chunky);
    }
    ...
    public Tag apply(final ArgumentQueue argumentQueue, final Context context) {
        ...
        if (runningTask == null) {
            ...
            return Tag.preProcessParsed(Long.toString(runningTask.getProgress().getMinutes()));
        }
    }
}
