...
public final class TaskPregenXPlaceholder extends ChunkyPlaceholder {
    public TaskPregenXPlaceholder(final Chunky chunky) {
        super(chunky);
    }
    ...
    public Tag apply(final ArgumentQueue argumentQueue, final Context context) {
        ...
        if (runningTask == null) {
            ...
            return Tag.preProcessParsed(Long.toString(runningTask.getProgress().getChunkX()));
        }
    }
}
