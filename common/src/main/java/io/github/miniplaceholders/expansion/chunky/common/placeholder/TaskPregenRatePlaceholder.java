...
public final class TaskPregenRatePlaceholder extends ChunkyPlaceholder {
    public TaskPregenRatePlaceholder(final Chunky chunky) {
        super(chunky);
    }
    ...
    public Tag apply(final ArgumentQueue argumentQueue, final Context context) {
        ...
        if (runningTask == null) {
            ...
            return Tag.preProcessParsed(Double.toString(runningTask.getProgress().getRate()));
        }
    }
}
