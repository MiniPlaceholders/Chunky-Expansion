...
public final class TaskPregenCenterXPlaceholder extends ChunkyPlaceholder {
    public TaskPregenCenterXPlaceholder(final Chunky chunky) {
        super(chunky);
    }
    ...
    public Tag apply(final ArgumentQueue argumentQueue, final Context context) {
        ...
        return toDoubleTag(task.map(GenerationTask::getSelection)
                .map(Selection::centerX));
    }
}
