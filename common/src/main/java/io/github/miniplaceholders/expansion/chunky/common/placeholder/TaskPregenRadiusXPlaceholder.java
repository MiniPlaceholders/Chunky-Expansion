...
public final class TaskPregenRadiusXPlaceholder extends ChunkyPlaceholder {
    public TaskPregenRadiusXPlaceholder(final Chunky chunky) {
        super(chunky);
    }
    ...
    public Tag apply(final ArgumentQueue argumentQueue, final Context context) {
        ...
        return toDoubleTag(task.map(GenerationTask::getSelection).map(Selection::radiusX));
    }
}
